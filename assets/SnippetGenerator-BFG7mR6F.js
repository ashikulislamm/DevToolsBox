import{r as i,u as P,j as e,m as R,e as G,f as U,n as B,h as _}from"./index-Bty-QInu.js";import{C as A,a as O,B as u}from"./Button-CCPPGs9u.js";import{I as F}from"./Input-DLl--kSo.js";import{T as C}from"./Textarea-Be-QwQXI.js";import{u as J}from"./useClipboard-COVLFtXx.js";function W(){const[r,q]=i.useState("GET"),[h,x]=i.useState(""),[j,g]=i.useState(""),[l,f]=i.useState(""),[$,T]=i.useState("fetch"),[p,b]=i.useState(""),[m,E]=i.useState(!1),{showToast:d}=P(),{copy:N}=J(),k=t=>{if(!t.trim())return{"Content-Type":"application/json"};const n=t.split(`
