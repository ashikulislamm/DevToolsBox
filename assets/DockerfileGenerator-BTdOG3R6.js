import{r as s,u as A,j as e,c as H,k as M}from"./index-BqCVcBBf.js";import{C as T,a as F,B as n}from"./Button-DmI0f6BQ.js";import{T as I}from"./Textarea-D1eCXekL.js";import{S as Y}from"./Select-BpaLeSxH.js";import{I as t}from"./Input-1J-PCWzW.js";import{u as W}from"./useClipboard-J38lvy7o.js";function V(){const[l,r]=s.useState("node:18-alpine"),[D,m]=s.useState("/app"),[u,o]=s.useState("npm"),[d,i]=s.useState("3000"),[P,j]=s.useState("."),[w,C]=s.useState("."),[y,g]=s.useState(""),[v,h]=s.useState(""),[b,c]=s.useState("npm start"),[N,$]=s.useState(""),[x,R]=s.useState(""),[S,B]=s.useState(!1),{showToast:p}=A(),{copy:U}=W(),z=[{value:"npm",label:"npm"},{value:"yarn",label:"yarn"},{value:"pnpm",label:"pnpm"},{value:"none",label:"None"}],G=()=>{if(!l.trim()){p("Please enter a base image.","error");return}let a=`# Use the official ${l} image
FROM ${l}
