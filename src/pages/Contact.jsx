      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        <div className="grid gap-8 lg:grid-cols-2">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <label className="flex items-start gap-3 text-sm text-gray-700 dark:text-slate-300">
                ...
                <span className="text-black">
                  ...
                  <a
                    href="#"
                    className="font-semibold underline text-[var(--accent-color)]"
                  >
                    Privacy Policy
                  </a>
                  .
              ...
              <button
                type="submit"
                className="mt-2 w-full rounded-md bg-[var(--accent-color)] hover:bg-[var(--accent-color)]/80 px-4 py-3 text-sm font-semibold text-white"
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-3xl font-semibold text-[var(--accent-color)]">
              Get in Touch
            </h3>
            ...
            <ul className="mt-8 space-y-5 text-[var(--accent-color)]">
